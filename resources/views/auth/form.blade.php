...
<div class="mb-3">
    ...
    value="{{ isset($user->password_repeat)?$user->password_repeat:'' }}" 
    placeholder="********">
</div>
<div class="mb-3">
    ...
    value="{{ isset($user->number_phone)?$user->number_phone:'' }}" 
...
<div class="mb-3">
    ...
    value="{{ isset($user->cedula_identidad)?$user->cedula_identidad:'' }}" 
